  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: 'space-x-1 flex items-center absolute inset-0 justify-between px-1',
        nav_button: cn(
          'h-7 w-7 bg-transparent p-0 text-gray-400 hover:text-white',
        ...
        cell: cn(
          'relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-[#2c3238]',
          'first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md'
        ),
        day: cn(
          'h-8 w-8 p-0 font-normal text-white hover:bg-[#2c3238] hover:text-white',
          'aria-selected:opacity-100'
        ),
        day_selected: 'bg-[#2c3238] text-white hover:bg-[#2c3238] hover:text-white focus:bg-[#2c3238] focus:text-white',
        ...
        <PopoverTrigger asChild disabled={disabled}>
          <Button
            ...
            className={cn(
              ...
              'bg-[#21262D] border-0 text-white hover:text-white hover:bg-[#21262D]',
